...
def render_analyze_index() -> bytes:
    ...
    <p><strong>Not:</strong> DC istisnaları: 18:00 DC değildir; 20:00 (Pazar hariç) DC olamaz; Cuma 16:00 DC sayılmaz. IOU kısıtları: 14:00, 16:00 ve 18:00 IOU değildir; 20:00 tüm günlerde IOU değildir; ayrıca <strong>Pazar günü hiçbir mum IOU olamaz</strong>.</p>
    """
...
def render_dc_index() -> bytes:
    ...
    <p><strong>Önemli:</strong> DC: 18:00 her zaman dışlanır; 20:00 yalnız Pazar hariç DC olabilir; Cuma 16:00 DC sayılmaz. IOU: 14:00, 16:00 ve 18:00 her gün yok; 20:00 tüm günlerde IOU değildir; <strong>Pazar günü IOU yoktur</strong>.</p>
    """
...
def render_iou_form() -> str:
    ...
    <p><strong>Not:</strong> 14:00, 16:00 ve 18:00 mumları IOU üretmez; 20:00 mumları tüm günlerde IOU olamaz; <strong>Pazar günü IOU yoktur</strong>.</p>
    """
